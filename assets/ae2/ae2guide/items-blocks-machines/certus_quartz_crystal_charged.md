...
<ItemLink id="certus_quartz_crystal" /> заряженный в <ItemLink id="charger" />. Используется для изготовления <ItemLink id="fluix_crystal" /> и [цветущих блоков истинного кварца](../items-blocks-machines/budding_certus.md).
